...
activities = {
    ...
    "Soccer Team": {
        "description": "Team-based soccer practice and regional matches",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 18,
        "participants": ["maria@mergington.edu", "alex@mergington.edu"]
    },
    "Basketball Club": {
        "description": "Learn basketball skills, teamwork, and play friendly games",
    ...
    "Drama Society": {
        "description": "Study acting, stagecraft, and perform school productions",
